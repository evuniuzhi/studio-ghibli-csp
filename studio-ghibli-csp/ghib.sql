...
('root', '[{\"db\":\"studio ghibli\",\"table\":\"studioghib\"},{\"db\":\"studio ghibli\",\"table\":\"studio ghib\"},{\"db\":\"studio ghibli\",\"table\":\"better\"},{\"db\":\"studio ghibli\",\"table\":\"studio ghibli\"}]');
...
('root', '2021-12-17 22:25:38', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":35}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Database: `studio ghibli`
--
CREATE DATABASE IF NOT EXISTS `studio ghibli` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `studio ghibli`;
...
--
-- Table structure for table `studio ghibli`
--

CREATE TABLE `studio ghibli` (
  `movie title` varchar(50) NOT NULL,
  `main characters` varchar(50) NOT NULL,
